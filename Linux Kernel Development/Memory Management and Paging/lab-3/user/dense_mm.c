...
int main (int argc, char* argv[])
{
	...
	sys_time = ((end_time.tv_sec * 1000000) + end_time.tv_usec) - ((start_time.tv_sec * 1000000) + start_time.tv_usec);
	...
	gettimeofday(&end_time, NULL);
	mul_time = ((end_time.tv_sec * 1000000) + end_time.tv_usec) - ((start_time.tv_sec * 1000000) + start_time.tv_usec);

	printf("System time is: %ld\n", sys_time);
	printf("Multiplication time is: %ld\n", mul_time);
